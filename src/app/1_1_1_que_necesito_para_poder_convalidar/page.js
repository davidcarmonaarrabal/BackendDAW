    ...
    <div className="pl-6 pt-4 pr-10">
      ...
      <div className="bg-blue-200 mt-10 p-3 pl-6 pr-6 rounded-xl shadow-[5px_5px_0px_rgba(0,0,0,0.1)]">
        ...
        <p className="pb-3 flex items-start"> ✓
          ...
          <span>Si eres alumno de SEMI o distancia: <b>estar matriculado/a en el módulo que se desea convalidar</b> y realizar el pago de las tasas correspondientes. Hasta que no se realice y se compruebe el pago, no se podrá ejecutar la convalidación en el expediente. De esta forma, si el pago se retrasa cabría la posibilidad de que la resolución de la convalidación también se retrasara.</span>
        </p>
